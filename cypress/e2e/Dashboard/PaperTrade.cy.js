...
it('Nift_Cash', () => {
  ...
  cy.xpath("(//input[@id='timepicker-1'])").should('be.visible').clear().type("12:50");
  cy.wait(500);
  cy.scrollTo(1000, 0);
...
//  cy.get(':nth-child(1) > :nth-child(2) > .form_item_wrap > :nth-child(2) > .d-flex > .border-0 > .form-control').clear();
 ...
 // cy.get('.secondary').click();
  ...
  //cy.get('.loader_numb').should("be.visible");
   ...
   cy.get('.text-start > .full_wrap > .form-control').type('user4')
   cy.wait(2000)
   cy.get('[style="float: none;"] > .common_anchor').click()
   cy.wait(4000)
//it.only('Stratergy', () => {
// cy.visit('https://strike.jainam.in/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..b51ENeTxd7iXuxF63Q832dykcopC7I3FXSeGRB1YMRo')
  ...
  cy.wait(500)
  cy.get('#txtStrategySearch').type('user4').type('{Enter}')
